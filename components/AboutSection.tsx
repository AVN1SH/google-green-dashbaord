        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <Reveal y={20}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-gray-900 leading-[1.1]">
              Empowering accountants <br className="hidden md:block"/> through automation
            </h2>
            
            <p className="mt-6 text-lg text-gray-600 max-w-xl leading-relaxed">
              Sketchbook is built on a simple idea: invoice management shouldn't be a headache. We process your data entirely in RAM, creating Tally-ready files securely.
            </p>
            ...
            <div className="mt-12 grid grid-cols-3 gap-8 border-t border-gray-100 pt-8">
              <div>
                ...
                <div className="mt-2 text-sm text-gray-600">Invoices Processed</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-gray-900">99%</div>
                <div className="mt-2 text-sm text-gray-600">Extraction accuracy</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-gray-900">100%</div>
                <div className="mt-2 text-sm text-gray-600">RAM Processed</div>
              </div>
            </div>
          </Reveal>
