      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <Reveal className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 mb-6">
            ...
            <span className="text-sm font-medium text-gray-800">Marketing power</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-gray-900 mb-6">
            Unlock the Full Power of Modern <br/> Marketing Automation
          </h2>
          <p className="text-lg text-gray-600">
            Leverage smart automation to boost engagement, conversions, and measurable business growth.
          </p>
        </Reveal>
            ...
            <div className="rounded-3xl border border-gray-100 bg-gray-50 p-8 h-full flex flex-col justify-between">
              <div className="space-y-4 mb-20">
                <div className="flex items-center gap-3 bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                  ...
                  <span className="text-sm font-medium text-gray-800">AI intelligence loaded</span>
                </div>
                <div className="flex items-center gap-3 bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                  <Settings className="w-5 h-5 text-gray-400" />
                  <span className="text-sm font-medium text-gray-800">Super clean workflow</span>
                </div>
                <div className="flex items-center gap-3 bg-white p-3 rounded-lg shadow-sm border border-gray-100 opacity-60">
                  <Users className="w-5 h-5 text-gray-400" />
                  <span className="text-sm font-medium text-gray-800">Assign tasks to members</span>
                </div>
              </div>
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Marketing intelligence</h3>
                <p className="text-sm text-gray-500">Turn real-time data into insights to optimize campaigns and drive smarter marketing growth.</p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={200} y={30}>
             <div className="rounded-3xl border border-gray-100 bg-white p-8 h-full flex flex-col justify-between items-center text-center shadow-sm relative overflow-hidden">
                <div className="absolute top-0 right-0 p-4">
                  <span className="flex items-center gap-1.5 rounded-full border border-gray-100 bg-white px-2 py-1 text-[10px] shadow-sm"><div className="w-1.5 h-1.5 bg-brand-dark rounded-full"/>Flowix</span>
                </div>
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-1">Good Morning, Robert Fox</h4>
                <p className="text-gray-500 mb-12">How Can I <span className="text-brand-dark font-medium">Assist You Today?</span></p>
                
                <div className="w-full text-left">
                   <h3 className="text-xl font-bold text-gray-900 mb-2">Growth automation</h3>
                   <p className="text-sm text-gray-500">Automate marketing workflows to accelerate business growth efficiently and intelligently.</p>
                </div>
             </div>
          </Reveal>
            ...
            <div className="rounded-3xl border border-gray-100 bg-gray-50 p-8 h-full flex flex-col justify-between">
              <div className="bg-white rounded-xl border border-gray-100 p-4 shadow-sm mb-12 w-full">
                <div className="flex justify-between items-center mb-4">
                   <span className="text-xs font-semibold text-gray-900">Repeat Weekly</span>
                   <span className="text-[10px] text-gray-400 bg-gray-50 px-2 py-0.5 rounded">Every Week</span>
                </div>
                <div className="flex justify-between text-xs font-medium text-gray-400 mb-4 px-2">
                   <span>S</span><span>S</span><span className="text-gray-900">M</span><span className="text-gray-900">T</span><span className="text-white bg-brand rounded-full w-6 h-6 flex items-center justify-center -m-1">W</span><span className="text-gray-900">T</span><span className="text-gray-900">F</span>
                </div>
                ...
                <div className="flex justify-between items-center text-[10px] border-t border-gray-100 pt-3">
                   ...
                   <span className="text-gray-900 font-medium">Sun, May 12, 2025</span>
                </div>
                <div className="flex gap-2 mt-4">
                   <button className="flex-1 rounded-full bg-gray-100 py-1.5 text-xs font-medium text-gray-600">Cancel</button>
                   <button className="flex-1 rounded-full bg-brand py-1.5 text-xs font-medium text-gray-900">Save</button>
                </div>
              </div>
              
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Performance boost</h3>
                <p className="text-sm text-gray-500">Improve campaign results with data-driven insights and intelligent marketing automation tools.</p>
              </div>
            </div>
          </Reveal>
        </div>
              ...
              <div className="rounded-3xl border border-gray-100 bg-white p-8 h-full shadow-sm flex flex-col justify-between">
                 <div>
                    <div className="flex justify-between items-start mb-6">
                       <div>
                          <h4 className="font-semibold text-gray-900 mb-1">Views 24 hours</h4>
