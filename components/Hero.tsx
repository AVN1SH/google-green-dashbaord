      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        <Reveal>
          <div className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white/60 backdrop-blur-sm px-4 py-1.5 shadow-sm">
            ...
            <span className="text-sm font-medium text-gray-800">100% RAM Data Processing</span>
          </div>
        </Reveal>

        <Reveal delay={100}>
          <h1 className="mx-auto mt-8 max-w-5xl text-5xl font-semibold tracking-tight text-gray-900 sm:text-6xl md:text-7xl">
            Automate invoices & <br/> statements to Tally
          </h1>
        </Reveal>

        <Reveal delay={200}>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600 leading-relaxed">
            Upload invoices, locked bank statements, or sync Google Drive. Sketchbook extracts data entirely in RAM and exports Tally-ready Excel sheets automatically to your drive.
          </p>
        </Reveal>
            ...
            <div className="p-6 md:p-8 flex gap-6 text-left">
              <div className="hidden md:flex w-48 flex-col gap-4 border-r border-gray-100 pr-6">
                <div className="flex items-center gap-2 mb-4">
                  <div className="h-8 w-8 rounded-lg bg-brand flex items-center justify-center font-bold text-gray-900">S</div>
                  <span className="font-semibold text-gray-800">Sketchbook</span>
                </div>
              ...
              <div className="flex-1 space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Here is a quick overview of your invoice processing today.</p>
                  </div>
                  <div className="cursor-pointer h-10 w-32 rounded-full bg-gray-900 text-white flex items-center justify-center text-xs font-medium hover:bg-gray-800 transition-colors">
                    + Upload Invoice
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="rounded-xl border border-gray-100 p-5 shadow-sm">
                    <h3 className="text-sm font-semibold text-gray-800 mb-4">Invoices Analyzed Today</h3>
                  ...
                  <div className="rounded-xl border border-gray-100 p-5 shadow-sm flex flex-col justify-between">
                    <h3 className="text-sm font-semibold text-gray-800 mb-4">Upload Sources</h3>
                    <div className="flex-1 flex items-center justify-center relative">
                      <svg viewBox="0 0 36 36" className="h-32 w-32 -rotate-90">
                        <path className="text-gray-100" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeWidth="4" />
                        <path className="text-brand" strokeDasharray="64, 100" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeWidth="4" />
                      </svg>
                      <div className="absolute flex flex-col items-center">
                        <span className="text-2xl font-bold">64%</span>
                        <span className="text-[10px] text-gray-400">Drive Sync</span>
                      </div>
                    </div>
                  </div>
                </div>
